...
{
	BROFILER_CATEGORY("PreUpdateRenderer", Profiler::Color::CadetBlue);
...
{
	BROFILER_CATEGORY("PostUpdateRenderer", Profiler::Color::DarkBlue);
...
// Blit to screen
bool j1Render::Blit(SDL_Texture* texture, int x, int y,SDL_RendererFlip flip, const SDL_Rect* section, float speed, double angle, int pivot_x, int pivot_y) const
{
	bool ret = true;
